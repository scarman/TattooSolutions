/* Bootstrap Country Picker - Copyright 2014 */

if (!jQuery) { throw new Error("Bootstrap Country Picker requires jQuery"); }
 
var BCPCountriesList = {
  'AF': 'Afghanistan',
  'AL': 'Albania',
  'DZ': 'Algeria',
  'AS': 'American Samoa',
...
+function ($) {
  ...
  var bcpCountries = function (element, options) {
    this.options = $.extend({}, $.fn.bcpcountries.defaults, options);
    ...
    if (this.$element.hasClass('bcp-selectbox')) {
  ...
  bcpCountries.prototype = {

    constructor: bcpCountries,
    ...
    getCountries: function() {
      ...
      if (this.options.available) {
        if (typeof this.options.available === 'string') {
          ...
          for (country in BCPCountriesList) {
            if (BCPCountriesList.hasOwnProperty(country)) {
              if ($.inArray(country, this.options.available) >= 0) {
                countries[country] = BCPCountriesList[country];
              }
            }
          }
        } else {
    ...
    addBootstrapCountries: function() {
      ...
      $toggle = this.$element.find('.bcp-selectbox-option');
      ...
      for (country in countries) {
        if (countries.hasOwnProperty(country)) {
          if (this.options.flags === true) {
            $options.append('<li><a tabindex="-1" href="#" data-option="' + country + '"><i class="glyphicon bcp-flag-' + country + '"></i>' + countries[country] + '</a></li>');
          } else {
    ...
    displayCountry: function () {
      ...
      if (this.options.flags === true) {
        this.$element.html('<i class="glyphicon bcp-flag-' + value + '"></i> ' + BCPCountriesList[value]);
      } else {
        this.$element.html(BCPCountriesList[value]);
      }
    }
  ...
  var old = $.fn.bcpcountries;

  $.fn.bcpcountries = function (option) {
    return this.each(function () {
      ...
      $this = $(this);
      data = $this.data('bcpcountries');
      options = typeof option === 'object' && option;

      if (!data) {
        $this.data('bcpcountries', (data = new bcpCountries(this, options)));
      }
  ...
  $.fn.bcpcountries.Constructor = bcpCountries;

  $.fn.bcpcountries.defaults = {
    country: '',
    available: '',
    flags: false,
    blank: true
  ...
  $.fn.bcpcountries.noConflict = function () {
    $.fn.bcpcountries = old;
    return this;
  };
  ...
  $(document).ready( function () {
    $('form select.bcp-countries, span.bcp-countries, div.bcp-countries').each(function () {
      var $countries;

      $countries = $(this);

      if ($countries.hasClass('bcp-selectbox')) {
        $countries.bcpselectbox($countries.data());
      }
      $countries.bcpcountries($countries.data());
    });
  });
...
+function ($) {
  ...
  var toggle = '[data-toggle=bcp-selectbox]',
      bcpSelectBox = function (element, options) {
        this.options = $.extend({}, $.fn.bcpselectbox.defaults, options);
        this.$element = $(element);

        this.initSelectBox();
      };

  bcpSelectBox.prototype = {

    constructor: bcpSelectBox,
    ...
    initSelectBox: function () {
      ...
      this.$element.html(
		...
		'<a class="bcp-selectbox-toggle ' + this.options.input + '" role="button" data-toggle="bcp-selectbox" href="#">' +
		'<span class="bcp-selectbox-option"></span>' +
		'<span class="' + this.options.icon + ' selectbox-caret"></span>' +
		'</a>' +
		'<div class="bcp-selectbox-options">' +
		'<div role="listbox">' +
		'<ul role="option">' +
		'</ul>' +
		'</div>' +
      ...
      if (this.options.filter === true) {
        this.$element.find('.bcp-selectbox-options').prepend('<div class="bcp-selectbox-filter-container"><input type="text" class="bcp-selectbox-filter form-control"></div>');
      }

      this.$element.val(this.options.value);

      this.$element
        .on('click.bcpselectbox.data-api touchstart.bcpselectbox.data-api', toggle, bcpSelectBox.prototype.toggle)
		.on('keydown.bcpselectbox.data-api', toggle + ', [role=option]' , bcpSelectBox.prototype.keydown)
		.on('mouseenter.bcpselectbox.data-api', '[role=option] > li > a', bcpSelectBox.prototype.mouseenter)
		.on('click.bcpselectbox.data-api', '[role=option] > li > a', bcpSelectBox.prototype.select)
		.on('click.bcpselectbox.data-api', '.bcp-selectbox-filter', function () { return false; })
		.on('propertychange.bcpselectbox.data-api change.bcpselectbox.data-api input.bcpselectbox.data-api paste.bcpselectbox.data-api', '.bcp-selectbox-filter', bcpSelectBox.prototype.filter);
    },
    ...
    toggle: function (e) {
      ...
      if (!isActive) {
        $parent.trigger(e = $.Event('show.bcpselectbox'));
    ...
    keydown: function (e) {
      ...
      $('body').off('mouseenter.bcp-selectbox.data-api', '[role=option] > li > a', bcpSelectBox.prototype.mouseenter);
      ...
      $('body').on('mouseenter.bcp-selectbox.data-api', '[role=option] > li > a', bcpSelectBox.prototype.mouseenter);
    },
    ...
    select: function (e) {
      ...
      $parent.trigger('change.bcpselectbox');
  ...
  function clearMenus() {
    ...
    $(toggle).each(function (e) {
      ...
      $parent.trigger(e = $.Event('hide.bcpselectbox'));
      ...
      $parent
        .removeClass('open')
        .trigger('hidden.bcpselectbox');
    });
  }

  function getParent($this) {
    return $this.closest('.bcp-selectbox');
  }


  /* SELECTBOX PLUGIN DEFINITION */

  var old = $.fn.bcpselectbox;

  $.fn.bcpselectbox = function (option) {
    return this.each(function () {
      var $this,
          data,
          options;
      ...
      $this = $(this);
      data = $this.data('bcpselectbox');
      options = typeof option === 'object' && option;
      this.type = 'bcpselectbox';

      if (!data) {
        $this.data('bcpselectbox', (data = new bcpSelectBox(this, options)));
      }
      if (typeof option === 'string') {
        data[option].call($this);
      }
  ...
  $.fn.bcpselectbox.Constructor = bcpSelectBox;

  $.fn.bcpselectbox.defaults = {
    icon: 'caret',
    input: 'form-control',
    name: '',
    value: '',
  ...
  $.fn.bcpselectbox.noConflict = function () {
    $.fn.bcpselectbox = old;
    return this;
  };
  ...
  $.valHooks.div = {
    ...
    set: function(el, val) {
      ...
      if ($(el).hasClass('bcp-selectbox')) {
        ...
        $el.find('.bcp-selectbox-option').html(html);
      } else if (origHook) {
  ...
  $(document).ready( function () {
    $('div.bcp-selectbox').each(function () {
      var $selectbox;

      $selectbox = $(this);

      $selectbox.bcpselectbox($selectbox.data());
    });
  });
  ...
  $(document)
    .on('click.bcpselectbox.data-api', clearMenus);
...
+function ($) {
  ...
  var bcpStates = function (element, options) {
    this.options = $.extend({}, $.fn.bcpstates.defaults, options);
    this.$element = $(element);
  ...
  bcpStates.prototype = {
    ...
    loadStates: function (country) {
      ...
      for (state in BCPStatesList[country]) {
        if (BCPStatesList[country].hasOwnProperty(state)) {
          this.$element.append('<option value="' + BCPStatesList[country][state].code + '">' + BCPStatesList[country][state].name + '</option>');
        }
      }
    ...
    addBootstrapStates: function() {
      ...
      if (country !== '') {
        ...
        if ($country.length !== 0) {
          ...
          $country.on('change.bcpselectbox', {state: this}, this.changeBootstrapCountry);
        }
      }
    ...
    loadBootstrapStates: function(country) {
      ...
      for (state in BCPStatesList[country]) {
        if (BCPStatesList[country].hasOwnProperty(state)) {
          $options.append('<li><a tabindex="-1" href="#" data-option="' + BCPStatesList[country][state].code + '">' + BCPStatesList[country][state].name + '</a></li>');

          if (BCPStatesList[country][state].code === stateCode) {
            stateName = BCPStatesList[country][state].name;
          }
        }
      }
  ...
  var old = $.fn.bcpstates;

  $.fn.bcpstates = function (option) {
    return this.each(function () {
      var $this,
          data,
          options;
      ...
      $this = $(this);
      data = $this.data('bcpstates');
      options = typeof option === 'object' && option;

      if (!data) {
        $this.data('bcpstates', (data = new bcpStates(this, options)));
      }
      if (typeof option === 'string') {
        data[option].call($this);
      }
  ...
  $.fn.bcpstates.Constructor = bcpStates;

  $.fn.bcpstates.defaults = {
    country: '',
    state: '',
    blank: true
  };
  ...
  $.fn.bcpstates.noConflict = function () {
    $.fn.bcpstates = old;
    return this;
  };
  ...
  $(document).ready( function () {
    $('form select.bcp-states, span.bcp-states, div.bcp-states').each(function () {
      var $states;

      $states = $(this);

      if ($states.hasClass('bcp-selectbox')) {
        $states.bcpselectbox($states.data());
      }
      $states.bcpstates($states.data());
    });
  });
